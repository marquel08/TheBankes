...
import img1 from '../assets/stonks.jpg';
import '../stylesX/Investment.css';

function Investment() {
    return(
        <div id='investBody'>
            <h1 id='investTitle'>Invest in something today!</h1>
            <br/>
            <img src={img1}/>
            <br/><br/>
            <p>Hey, you! Are you tired of not knowing what to do with all that capital income you've acquired? Well, I've got the solution for you!</p>
            <br/>
